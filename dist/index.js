(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("connected-react-router"), require("immutable"), require("lodash"), require("query-string"), require("react"), require("react-redux"), require("react-router"), require("redux"), require("redux-act"), require("redux-saga"), require("reselect"));
	else if(typeof define === 'function' && define.amd)
		define(["connected-react-router", "immutable", "lodash", "query-string", "react", "react-redux", "react-router", "redux", "redux-act", "redux-saga", "reselect"], factory);
	else if(typeof exports === 'object')
		exports["index"] = factory(require("connected-react-router"), require("immutable"), require("lodash"), require("query-string"), require("react"), require("react-redux"), require("react-router"), require("redux"), require("redux-act"), require("redux-saga"), require("reselect"));
	else
		root["index"] = factory(root[undefined], root[undefined], root[undefined], root[undefined], root[undefined], root[undefined], root[undefined], root[undefined], root[undefined], root[undefined], root[undefined]);
})(window, function(__WEBPACK_EXTERNAL_MODULE_connected_react_router__, __WEBPACK_EXTERNAL_MODULE_immutable__, __WEBPACK_EXTERNAL_MODULE_lodash__, __WEBPACK_EXTERNAL_MODULE_query_string__, __WEBPACK_EXTERNAL_MODULE_react__, __WEBPACK_EXTERNAL_MODULE_react_redux__, __WEBPACK_EXTERNAL_MODULE_react_router__, __WEBPACK_EXTERNAL_MODULE_redux__, __WEBPACK_EXTERNAL_MODULE_redux_act__, __WEBPACK_EXTERNAL_MODULE_redux_saga__, __WEBPACK_EXTERNAL_MODULE_reselect__) {
